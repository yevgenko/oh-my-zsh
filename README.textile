...
@wget --no-check-certificate https://github.com/brunoferreirapinto/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/brunoferreirapinto/oh-my-zsh.git ~/.oh-my-zsh@
...
** example: @plugins=(rails git ruby svn)@
...
* "View our growing list of contributors":https://github.com/brunoferreirapinto/oh-my-zsh/contributors
